...
///////////////////////////////////////////////////////////////////////////////////
  ...
  function testeCollisionJoueurMonstres() {
    //console.log(allPlayers[username]);
    for (var i = 0; i < tabMonstres.length; i++) {
      if (circRectsOverlap(tabMonstres[i].x1, tabMonstres[i].y1,80,60, allPlayers[username].x, allPlayers[username].y, allPlayers[username].r)) {
        return true;
      }
    }
    return false;
...
///////////////////////////////////////////////////////////////////////////////////
  ...
  function quelMonstreMort() {
    for (var i = 0; i < tabMonstres.length; i++) {
      if (circRectsOverlap(tabMonstres[i].x, tabMonstres[i].y, 100, 100, allPlayers[username].x, allPlayers[username].y, allPlayers[username].r)) {
        return i;
      }
    }
    return false;
